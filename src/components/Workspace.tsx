...
import { ProfileView } from '@/components/workspace/Profile';
...
import {
  ArrowUpRight, Bell, CalendarDays, ChevronDown, CircleHelp, ClipboardCheck, Building2, BellRing, FileText, UserCircle,
...
export type View = 'overview' | 'subscription' | 'tasks' | 'projects' | 'team' | 'schedule' | 'messages' | 'department' | 'notices' | 'applications' | 'profile' | 'transactions' | 'settings';
...
const navItems: NavItem[] = [
  ...
  { label: 'Departments', icon: Building2, view: 'department' },
  { label: 'Notices', icon: BellRing, view: 'notices' },
  { label: 'Applications', icon: FileText, view: 'applications' },
  { label: 'My profile', icon: UserCircle, view: 'profile' },
];
