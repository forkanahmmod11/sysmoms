...
The source package was syntax-checked across all TypeScript/TSX files before packaging. Render should run `npm install` and then the configured `npm run build`.
